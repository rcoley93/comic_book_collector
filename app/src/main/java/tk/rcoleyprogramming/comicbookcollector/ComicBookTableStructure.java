...
public final class ComicBookTableStructure {
    ...
    public static abstract class ComicBookEntry implements BaseColumns {
        ...
        public static final String coverDate = "cover_date";
    ...
    public static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + ComicBookEntry.tableName + " (" +
                    ...
                    ComicBookEntry.coverDate + TEXT_TYPE + COMMA_SEP +
                    ...
                    ComicBookEntry.readUnread + " BOOLEAN" + COMMA_SEP +
                    ComicBookEntry.dateAcquired + TEXT_TYPE + COMMA_SEP +
                    ComicBookEntry.locationAcquired + TEXT_TYPE + COMMA_SEP +
                    ComicBookEntry.comicLocation + TEXT_TYPE + " )";
